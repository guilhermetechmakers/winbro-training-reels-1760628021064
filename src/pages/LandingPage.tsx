...
import { ArrowRight, Play, CheckCircle, Star, Users, Award, Clock, Shield, Zap, Target, TrendingUp } from 'lucide-react'
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in-up">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  <Badge variant="secondary" className="w-fit animate-bounce-in">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight">
                  ...
                  <span className="gradient-text animate-gradient-x bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent bg-[length:200%_auto]">
                    Training Reels
                  </span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="group btn-hover shadow-lg hover:shadow-xl" asChild>
                  <Link to="/auth/signup">
                    Start Free Trial
                    <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </Button>
                <Button size="lg" variant="outline" className="group btn-hover" asChild>
                  <Link to="/demo">
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground">
                <div className="flex items-center animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <div className="relative animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-card to-card/50 backdrop-blur-sm border border-border/50">
                <div className="aspect-video bg-gradient-to-br from-primary/20 via-secondary/10 to-primary/20 flex items-center justify-center relative">
                  {/* Animated Background Pattern */}
                  <div className="absolute inset-0 opacity-20">
                    <div className="absolute top-4 left-4 w-2 h-2 bg-primary rounded-full animate-ping" />
                    <div className="absolute top-8 right-8 w-1 h-1 bg-secondary rounded-full animate-ping" style={{ animationDelay: '1s' }} />
                    <div className="absolute bottom-6 left-8 w-1.5 h-1.5 bg-primary rounded-full animate-ping" style={{ animationDelay: '2s' }} />
                    <div className="absolute bottom-4 right-4 w-2 h-2 bg-secondary rounded-full animate-ping" style={{ animationDelay: '0.5s' }} />
                  </div>
                  
                  <div className="text-center space-y-6 z-10">
                    <div className="w-24 h-24 mx-auto bg-gradient-to-br from-primary/30 to-secondary/30 rounded-full flex items-center justify-center shadow-lg animate-pulse-slow">
                      <Play className="w-10 h-10 text-primary ml-1" />
                    </div>
                    <div className="space-y-2">
                      <p className="text-lg font-semibold text-foreground">Hero Video Preview</p>
              ...
              <div className="absolute -top-6 -right-6 bg-card/90 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-border/50 animate-bounce-in hover:scale-105 transition-transform duration-300">
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse shadow-lg" />
                  <div>
                    <p className="text-sm font-semibold text-foreground">Live Training</p>
                    <p className="text-xs text-muted-foreground">2,847 watching</p>
                  </div>
                </div>
              </div>
              
              <div className="absolute -bottom-6 -left-6 bg-card/90 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-border/50 animate-bounce-in hover:scale-105 transition-transform duration-300" style={{ animationDelay: '400ms' }}>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full flex items-center justify-center">
                    <Users className="w-5 h-5 text-primary" />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-foreground">2,847 views</p>
              ...
              <div className="absolute top-1/2 -right-12 bg-card/80 backdrop-blur-sm rounded-xl p-3 shadow-lg border border-border/50 animate-float hover:scale-105 transition-transform duration-300">
                <div className="flex items-center space-x-2">
                  <TrendingUp className="w-4 h-4 text-green-500" />
                  <span className="text-xs font-medium text-foreground">+127% engagement</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto max-w-7xl relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 animate-stagger">
            {features.map((feature) => (
              <Card key={feature.title} className="group hover:shadow-xl hover:-translate-y-2 transition-all duration-500 border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm relative overflow-hidden">
                {/* Card Background Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-secondary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                
                <CardHeader className="relative z-10">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg">
        ...
        <div className="container mx-auto max-w-7xl relative">
          ...
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            {steps.map((step, index) => (
              <div key={step.title} className="text-center space-y-6 animate-fade-in-up group" style={{ animationDelay: `${index * 200}ms` }}>
                <div className="relative">
                  {/* Step Number Circle */}
                  <div className="w-20 h-20 mx-auto bg-gradient-to-br from-primary via-primary/90 to-secondary rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 relative z-10">
                    {index + 1}
                  </div>
                  
                  {/* Connecting Line */}
                  {index < steps.length - 1 && (
                    <div className="hidden md:block absolute top-10 left-1/2 w-full h-1 bg-gradient-to-r from-primary/30 via-primary to-secondary/30 transform translate-x-10 rounded-full" />
                  )}
                  
                  {/* Glow Effect */}
                  <div className="absolute inset-0 w-20 h-20 mx-auto bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full blur-xl group-hover:blur-2xl transition-all duration-500" />
                </div>
                ...
                {/* Decorative Element */}
                <div className="w-16 h-1 bg-gradient-to-r from-primary/30 to-secondary/30 rounded-full mx-auto group-hover:w-24 transition-all duration-300" />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 animate-stagger">
            {testimonials.map((testimonial) => (
              <Card key={testimonial.name} className="group hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm relative overflow-hidden">
                {/* Card Background Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-secondary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        <div className="container mx-auto max-w-7xl relative">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto animate-stagger">
            {pricingPlans.map((plan, index) => (
              <Card key={plan.name} className={`relative group hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-0 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm overflow-hidden ${plan.featured ? 'scale-105 shadow-2xl' : ''}`} style={{ animationDelay: `${index * 100}ms` }}>
                {/* Featured Badge */}
                {plan.featured && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                    <Badge className="bg-gradient-to-r from-primary to-secondary text-white px-6 py-2 text-sm font-semibold shadow-lg animate-bounce-in">
                      Most Popular
                    </Badge>
                  </div>
                )}
                ...
                <CardHeader className="text-center pt-8 relative z-10">
                  <CardTitle className="text-2xl lg:text-3xl font-bold group-hover:text-primary transition-colors duration-300">
                    {plan.name}
                  </CardTitle>
                  <div className="space-y-4 mt-6">
                    <div className="text-5xl lg:text-6xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                      ${plan.price}
                ...
                <CardContent className="space-y-8 relative z-10">
                  ...
                  <Button 
                    className={`w-full h-12 text-lg font-semibold ${plan.featured ? 'btn-hover shadow-lg hover:shadow-xl' : 'btn-hover'}`}
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button size="lg" variant="secondary" className="group btn-hover shadow-xl hover:shadow-2xl text-lg px-8 py-4" asChild>
                <Link to="/auth/signup">
                  Start Free Trial
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </Link>
              </Button>
              <Button size="lg" variant="outline" className="text-white border-white/30 hover:bg-white hover:text-primary btn-hover text-lg px-8 py-4 backdrop-blur-sm" asChild>
                <Link to="/demo">
